# Initial Prompt for Windsurf (no commit version)

Always follow the instructions in `__plans__/plan.md`. When I say "go", find the next unmarked test in plans/plan.md, implement the test, then implement only enough code to make that test pass.
