...
const TRANSITIONS = {
  ...
  '7': { roomId: 'the-wilds-east' as RoomId, target: [1, 1] as [number, number], returnPoint: [26, 7] as [number, number] },
  '8': { roomId: 'the-wilds-east' as RoomId, target: [2, 1] as [number, number], returnPoint: [26, 8] as [number, number] },
  '9': { roomId: 'the-wilds-east' as RoomId, target: [3, 1] as [number, number], returnPoint: [26, 9] as [number, number] },
  '10': { roomId: 'the-wilds-east' as RoomId, target: [4, 1] as [number, number], returnPoint: [26, 10] as [number, number] },
  '11': { roomId: 'the-wilds-east' as RoomId, target: [5, 1] as [number, number], returnPoint: [26, 11] as [number, number] },
  '12': { roomId: 'the-wilds-east' as RoomId, target: [6, 1] as [number, number], returnPoint: [26, 12] as [number, number] },
  '13': { roomId: 'the-wilds-east' as RoomId, target: [7, 1] as [number, number], returnPoint: [26, 13] as [number, number] },
  '14': { roomId: 'the-wilds-east' as RoomId, target: [8, 1] as [number, number], returnPoint: [26, 14] as [number, number] },
  '15': { roomId: 'the-wilds-east' as RoomId, target: [9, 1] as [number, number], returnPoint: [26, 15] as [number, number] },
  '16': { roomId: 'the-wilds-east' as RoomId, target: [10, 1] as [number, number], returnPoint: [26, 16] as [number, number] },
  '17': { roomId: 'the-wilds-east' as RoomId, target: [11, 1] as [number, number], returnPoint: [26, 17] as [number, number] },
  '18': { roomId: 'the-wilds-east' as RoomId, target: [12, 1] as [number, number], returnPoint: [26, 18] as [number, number] },
  '19': { roomId: 'the-wilds-east' as RoomId, target: [13, 1] as [number, number], returnPoint: [26, 19] as [number, number] },
  '20': { roomId: 'the-wilds-east' as RoomId, target: [14, 1] as [number, number], returnPoint: [26, 20] as [number, number] },
