...
export enum TileSubtype {
  ...
  EXTRA_HEART = 50,
  OPEN_ABYSS = 51,
  // Bomb item: BOMB is the carryable/chest pickup (grants a 5-pack), BOMB_LIVE is a
  ...
  // use, or kept as an end-screen prize); BERRY is the belted berry (heals 3-4 on use).
  PINK_HEART = 56,
  BERRY = 57,
