...
export default function PreloadImages() {
  useEffect(() => {
    const urls: string[] = [
      ...
      "/images/enemies/fire-goblin/pink-goblin-front.png",
      "/images/enemies/fire-goblin/pink-goblin-left.png",
      "/images/enemies/fire-goblin/pink-goblin-back.png",
      "/images/enemies/fire-goblin/pink-ring.png",
