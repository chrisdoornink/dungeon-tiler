    ...
    const commitAndImpact = () => {
      ...
      if (impact) {
        ...
        setBamEffect({
          y: impact.y,
          x: impact.x,
          src: assetUrl(`/images/items/bam${bamIdx}-clean.png`),
        });
    ...
    (direction: Direction) => {
      ...
      if (playerPosition && gameState.enemies && gameState.enemies.length > 0) {
        ...
        if (enemy) {
          ...
          const choices = [
            assetUrl("/images/items/bam1-clean.png"),
            assetUrl("/images/items/bam2-clean.png"),
            assetUrl("/images/items/bam3-clean.png"),
          ];
      ...
      if (playerPosition) {
        ...
        if (preHadPot && !postHasPot) {
          ...
          setBamEffect({ y: ty, x: tx, src: assetUrl(`/images/items/bam${bamIdx}-clean.png`), size: 20 });
          setTimeout(() => setBamEffect(null), 300);
        }
      }
      ...
      {travelAnimation && (travelAnimation.phase === 'sparkle-out' || travelAnimation.phase === 'sparkle-in') && (
        <div className="fixed inset-0 z-[9999] pointer-events-none flex items-center justify-center">
          <div className="relative w-64 h-64">
            <img
              src={assetUrl("/images/items/travel-sparkle-large-clean.png")}
              alt=""
              className="absolute inset-0 w-full h-full animate-pulse"
              style={{ animationDuration: '0.3s' }}
            />
            <img
              src={assetUrl("/images/items/travel-sparkle-small-clean.png")}
              alt=""
                      ...
                      >
                        <span
                          ...
                          style={{
                            ...
                            backgroundImage: `url(${assetUrl("/images/items/key-clean.png")})`,
                            backgroundSize: "contain",
                            backgroundRepeat: "no-repeat",
                            backgroundPosition: "center",
                          }}
                      ...
                      >
                        <span
                          ...
                          style={{
                            ...
                            width: isCompact ? 28 : 20,
                            height: isCompact ? 28 : 20,
                            backgroundImage: `url(${assetUrl("/images/items/exit-key-clean.png")})`,
                            backgroundSize: "contain",
                            backgroundRepeat: "no-repeat",
                            backgroundPosition: "center",
                          }}
                      ...
                      >
                        <span
                          ...
                          style={{
                            ...
                            width: isCompact ? 28 : 20,
                            height: isCompact ? 28 : 20,
                            backgroundImage: `url(${assetUrl("/images/items/shield-clean.png")})`,
                            backgroundSize: "contain",
                            backgroundRepeat: "no-repeat",
                            backgroundPosition: "center",
                          }}
                      ...
                      >
                        <span
                          ...
                          style={{
                            ...
                            width: 32,
                            height: 32,
                            backgroundImage: `url(${assetUrl("/images/items/bomb-black-clean.png")})`,
                            backgroundSize: "contain",
                            backgroundRepeat: "no-repeat",
                            backgroundPosition: "center",
                          }}
                      ...
                      >
                        <span
                          ...
                          style={{
                            ...
                            width: 32,
                            height: 32,
                            backgroundImage: `url(${assetUrl("/images/items/food-1-clean.png")})`,
                            backgroundSize: "contain",
                            backgroundRepeat: "no-repeat",
                            backgroundPosition: "center",
                          }}
                      ...
                      >
                        <span
                          ...
                          style={{
                            ...
                            width: 32,
                            height: 32,
                            backgroundImage: `url(${assetUrl("/images/items/pink-heart-clean.png")})`,
                            backgroundSize: "contain",
                            backgroundRepeat: "no-repeat",
                            backgroundPosition: "center",
                          }}
                    ...
                    return heroBangs.map((b) => (
                      <div
                        ...
                        style={{
                          ...
                          width: `${size}px`,
                          height: `${size}px`,
                          backgroundImage: `url(${assetUrl("/images/items/bam2-clean.png")})`,
                          backgroundSize: "contain",
                          backgroundRepeat: "no-repeat",
                          backgroundPosition: "center",
        ...
        inventoryItems={[
          ...
          ...((gameState.foodCount ?? 0) > 0
            ? [{
                key: "food",
                label: "Food",
                icon: assetUrl("/images/items/food-1-clean.png"),
          ...
          ...((gameState.potionCount ?? 0) > 0
            ? [{
                key: "potion",
                label: "Potion",
                icon: assetUrl("/images/items/meds-1-clean.png"),
          ...
          ...((gameState.pinkHeartCount ?? 0) > 0
            ? [{
                key: "pink-heart",
                label: "Pink Heart",
                icon: assetUrl("/images/items/pink-heart-clean.png"),
          ...
          ...(gameState.hasSnakeMedallion
            ? [{
                key: "medallion",
                label: "Medallion",
                icon: assetUrl("/images/items/snake-medallion-blue-clean.png"),
          ...
          ...(gameState.hasKey || (gameState.chestKeyCount ?? 0) > 0
            ? [{
                ...
                icon: assetUrl("/images/items/key-clean.png"),
                count: (gameState.chestKeyCount ?? 0) > 0 ? gameState.chestKeyCount : undefined,
              }]
            : []),
          ...(gameState.hasExitKey
            ? [{ key: "exit-key", label: "Exit Key", icon: assetUrl("/images/items/exit-key-clean.png") }]
            : []),
          ...(gameState.hasSword
            ? [{ key: "sword", label: "Sword", icon: assetUrl("/images/items/sword-clean.png") }]
            : []),
          ...(gameState.hasShield
            ? [{ key: "shield", label: "Shield", icon: assetUrl("/images/items/shield-clean.png") }]
            : []),
        ]}
      />
    </div>
      ...
      return (
        ...
        >
          <Tile
            ...
            // Boss pose — ONE shared prop, so every boss's tell is resolved here by kind.
            enemyPose={(() => {
              const mem = enemyAtTile?.behaviorMemory as
                | Record<string, unknown>
                | undefined;
              if (enemyAtTile?.kind === "fisher") {
              ...
              if (enemyAtTile?.kind === "quarrymaster") {
                return quarrymasterIsSummoning(mem) ? ("summon" as const) : undefined;
              }
              if (enemyAtTile?.kind === "coilwyrm") {
                // Read straight off behaviourMemory. "reared" is the post-bite recoil (it
                // cannot bite, so adjacency is safe) and "surging" a two-tile turn. Both are
                // CSS stand-ins until dedicated art exists.
                const coil = mem as
                  | { biteRecoil?: number; surging?: boolean }
                  | undefined;
                if ((coil?.biteRecoil ?? 0) > 0) return "reared" as const;
                if (coil?.surging === true) return "surging" as const;
              }
              return undefined;
            })()}
